...
import img1 from '../../assets/images/linkedin.png'
import { Link } from 'react-router-dom';


const Footer = () => {
    return (
      <div className='bg-slate-200 text-black fixed bottom-0 w-full'>
  ...
  <aside className="items-center grid-flow-col">
    ...
    <p>Copyright © 2024 - All right reserved by Eshtiaque</p>
  </aside> 
  <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
  <div className="grid grid-flow-col gap-4">
                       
                        
  <Link to="https://www.facebook.com/profile.php?id=100009017782174"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></Link>

                        
                        <Link to="https://www.linkedin.com/in/eshtiaque-ahmed-150097235/"><img className='h-6 w-6 items-center text-center ' src={img1} alt="" /></Link>
                        <Link to="https://www.instagram.com/lam_sajid/"><img className='h-6 w-6 items-center text-center' src={img2} alt="" /></Link>
